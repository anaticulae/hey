...
@pytest.mark.parametrize('raw, expected', [
    (
        ...
        iamraw.TitleDate(2010, 6, 4, 'Berlin', True, 'Berlin, den 4. Juni 2010'),
    ),
    (
        'Berlino, 19. April 2016',
        iamraw.TitleDate(2016, 4, 19, 'Berlino', True, 'Berlino, 19. April 2016'),
    ),
    (
        'Berlin, 39. April 2016',
        iamraw.TitleDate(2016, 4, 39, 'Berlin', False, 'Berlin, 39. April 2016'),
    ),
    (
        '19. April 2016',
