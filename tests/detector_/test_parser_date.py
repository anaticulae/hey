...
@pytest.mark.parametrize('raw, expected', [
    ...
    (
        ...
        TitleDate(2016, 4, 19, 'Berlino', True, 'Berlino, 19. April 2016'),
    ),
    (
        'Berlin, 39. April 2016',
        TitleDate(2016, 4, 39, 'Berlin', False, 'Berlin, 39. April 2016'),
    ),
    (
        '19. April 2016',
        TitleDate(2016, 4, 19, None, True, '19. April 2016'),
    ),
    (
        'Abgabedatum: 15. Jan 2010 ',
        TitleDate(2010, 1, 15, None, True, '15. Jan 2010'),
    ),
    (
        'Juli 2003 ',
        TitleDate(2003, 7, None, None, True, 'Juli 2003'),
    ),
    (
        'INFOTEH-JAHORINA Vol. 14, März 2015.',
        TitleDate(2015, 3, 14, None, True, '14, März 2015'),
    ),
    (
        ' 21.05.1999  random',
        TitleDate(1999, 5, 21, None, True, '21.05.1999'),
    ),
    (
        'date: 21.5.1999',
        TitleDate(1999, 5, 21, None, False, '21.5.1999'),
    ),
    (
        'Stand: 07.04.2013 ',
        TitleDate(2013, 4, 7, None, True, '07.04.2013'),
    ),
    (
