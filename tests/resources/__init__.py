...
RESTRUCT = join(GENERATED, 'restruct')
...
RESTRUCT_PDF = join(RESOURCES, 'restruct/restructuredtext.pdf')
...
SIMPLE_ONELINE_POSITION = join(SIMPLE, ONELINE_POSITION)
...
PYPORTING = join(GENERATED, 'porting_module')
